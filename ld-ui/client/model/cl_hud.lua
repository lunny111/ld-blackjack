...
-- AddEventHandler("ld-ui:watch", function()
...
-- AddEventHandler("ld-ui:voice:setvoiceRange", function(proximity)
--     sendAppEvent("hud", {
...
-- AddEventHandler("ld-ui:voice:setRadioActive", function()
--     print('fucci')
--     sendAppEvent("hud", {
--         voiceActive = false,
...
-- AddEventHandler("ld-ui:voice:setRadioActiveFinished", function()
--     print('fucci--dead')
--     sendAppEvent("hud", {
--         voiceActive = false,
...
--         -- for k,v in pairs(exports["tp-base"]:getModule("Blips")) do
