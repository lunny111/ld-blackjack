...
RegisterNetEvent("ld-ui:open-application")
AddEventHandler("ld-ui:open-application", openApplication)
...
function closeApplication(app, data)
    ...
    TriggerEvent("ld-ui:application-closed", app, { fromEscape = false })
end
