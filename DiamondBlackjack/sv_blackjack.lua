...
function tryTakeChips(source,amount)
    ...
    user.removeInventoryItem("casino_chips", amount)
    return true
end
...
RegisterNetEvent("Blackjack:svDrawText")
AddEventHandler("Blackjack:svDrawText", function(display,draw1,draw2)
    TriggerClientEvent("Blackjack:clDrawText",source,display,draw1,draw2)
end)
...
ESX.RegisterServerCallback("Blackjack:getCasinoChips", function(source, cb, item)
    xPlayer = ESX.GetPlayerFromId(source)
    if xPlayer == nil then cb(0) return end
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    if lostAmount > 10000000 then
                                                        TriggerClientEvent('chatMessage', -1, "Diamond Casino | " .. GetPlayerName(source) .. " Pesdeste " .. tostring(getMoneyStringFormatted(lostAmount)) .. " chips!")
                                                    end
